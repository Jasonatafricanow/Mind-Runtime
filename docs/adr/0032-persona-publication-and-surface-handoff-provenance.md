# ADR-0032: Immutable Persona publication and durable W3 handoff provenance

- Date: 2026-09-23
- Status: **ACCEPTED**
- Accepted by: PERSONA AUTHORITY DECISION and ARCHITECTURE CONFLICT RESOLUTION, MR-W3-E-AUTHORITY-HARDENING-01
- Extends ADR-0031 and the E3 interpretation in `MR_ARCHITECTURE_LOCK_v1_1.md`
...
gates of ADR-0031 are unchanged.
