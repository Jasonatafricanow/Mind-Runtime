...
COGNITIVE_MODE_V0_REGISTRY: MappingProxyType[CognitiveMode, CognitiveModeSpec] = MappingProxyType(
    {
        ...
        CognitiveMode.SLEEP: CognitiveModeSpec(
            ...
            purpose=(
                ...
                "provide future processing windows for affect consolidation, slow-state maintenance, "
        ...
        CognitiveMode.DREAM: CognitiveModeSpec(
            ...
            purpose=(
                "Sleep-associated loose-association processing mode for cross-memory/cross-semantic "
