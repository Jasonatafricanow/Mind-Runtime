...
from mind_runtime.surface.recipe import (
    ALL_DECLARED_DYNAMICS_ROOTS, CANDIDATE_RECIPE_DIGEST,
    CANDIDATE_RECIPE_ID, CANDIDATE_RECIPE_VERSION, MANIFEST,
)
...
def _scope_wire(scope: object) -> dict[str, object]:
    ...
    return {
        "domain": domain.value if hasattr(domain, "value") else None,
