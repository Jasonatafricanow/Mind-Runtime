...
def _seed_demo_live_trace(
    ...
    """Seed one synthetic trace using the current transition contract."""
    ...
    cache.append(live.observe(interaction_id="ix-debug-1", result=result))
